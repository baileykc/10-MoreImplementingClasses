    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        h_rect = rg.Rectangle(rg.Point(self.intersection_center.x + (self.width/2), self.intersection_center.y - self.letter_thickness/2), rg.Point(self.intersection_center.x - (self.width/2), self.intersection_center.y + self.letter_thickness/2))
        self.h_rect = h_rect
        v_rect = rg.Rectangle(rg.Point(intersection_center.x - letter_thickness/2, intersection_center.y - letter_thickness/2), rg.Point(intersection_center.x + letter_thickness/2, intersection_center.y + self.height - letter_thickness/2))
        self.v_rect = v_rect
